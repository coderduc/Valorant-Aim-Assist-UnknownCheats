...
int APIENTRY WinMain(HINSTANCE, HINSTANCE, LPSTR, int)
{
    ...
    if (FileExists("config.ini") == true) {
        ...
        if (loadSelect == "YES") {
            ...
            double sensitivity_x = 1.0 / sensitivity / (screen_width / 1366.0) * 1.08;
            double sensitivity_y = 1.0 / sensitivity / (screen_height / 768.0) * 1.08;
                            ...
                            if (((mode & 1) > 0) && (VK_LBUTTON)) {
                                ...
                                if (elapsed_time_ms > 7) {
                                    ...
                                    if (aim_x != 0 || aim_y != 0) {
                                        ...
                                        double extra = 38.0 * (screen_height / 768.0) * (recoil_ms / 1000.0);
                                        if (!left_down) {
                                            extra = 0;
                                        }
                                        else if (extra > 38.0) {
